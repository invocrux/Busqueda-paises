...
export class Convert {
    public static toSearchGifsResponsive(json: string): Pais[] {
        return cast(JSON.parse(json), a(r("SearchGifsResponsive")));
    }

    public static searchGifsResponsiveToJson(value: Pais[]): string {
        return JSON.stringify(uncast(value, a(r("SearchGifsResponsive"))), null, 2);
    }
}
